...
module.exports = async (interaction) => {
  ...
  if (interaction.customId === 'edited') {
    ...
    const modal = new ModalBuilder()
      .setCustomId('FormEdit')
      .setTitle('Edit Data');
    const usernameInput = new TextInputBuilder()
      .setCustomId('usernameInput')
      .setLabel("New/Current Discord Username")
      .setRequired(true)
      .setStyle(TextInputStyle.Short);

    const inGameNameInput = new TextInputBuilder()
      .setCustomId('ignInput')
      .setLabel("New/Current War Thunder In-game Name")
      .setRequired(true)
      .setStyle(TextInputStyle.Short);
    ...
    const thirdActionRow = new ActionRowBuilder().addComponents(tokenInput);
